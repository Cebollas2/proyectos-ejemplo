...
public class ConsumoDTO {
	...
	private List<DetalleConsumoDTO> detalles = new ArrayList<>();
	...
	public List<DetalleConsumoDTO> getDetalles() {
		return detalles;
	}

	public void setDetalles(List<DetalleConsumoDTO> detalles) {
