	...
	<tbody>
		...
		<tr>
			...
			<table align="center" border="0" cellpadding="15" cellspacing="0" width="100%">
				<tbody>
					<tr>
						<td align="center" style="background:#00609c;color:#ffffff">							
							<p>Radio Búsquedas</p>
						</td>
					</tr>
					<tr>
						<td align="center" style="background:#d9e7f0;color:#00609C">							
							<p>${texto}</p>
						</td>
					</tr>
				</tbody>
			...
			<table align="center" border="0" cellpadding="5" cellspacing="0" width="100%" style="background: #d9e7f0;">
				<tbody>
					<tr id="footer-container">
						<td align="left" >
							<p>Cione Grupo de Ópticas</p>							
						</td>
						<td align="right">
							<p><strong>91 640 29 80 </strong> • info@cione.es</p>
						</td>
					</tr>
				</tbody>
			</table>
