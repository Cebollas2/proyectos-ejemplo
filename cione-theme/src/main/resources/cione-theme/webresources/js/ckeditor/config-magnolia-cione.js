...
//CKEDITOR.plugins.addExternal('magnoliaExpand', '/cione-theme/webresources/js/magnoliaexpand/');
...
CKEDITOR.editorConfig = function( config ) {
	...
	config.toolbar_Magnolia = [
		...
		{ name: "paragraph",     items: [ "NumberedList", "BulletedList", "JustifyLeft", "JustifyCenter", "JustifyRight", "JustifyBlock", "Image" ] },
